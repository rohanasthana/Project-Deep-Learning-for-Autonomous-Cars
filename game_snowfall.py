...
class CarRacing(gym.Env, EzPickle):
	...
	def render(self, mode="human"):
		...
		self.render_snow(WINDOW_W,WINDOW_H)
	...
	def render_road(self):
		...
		#rectR.draw()
		#self.draw_rect(0,0,50,50,(50,50,50,50))
	...
	# for is less likely to get stuck than while
		...
		# dest_x = random.randint(0,96)
		# dest_y = random.randint(0,96)
		# print(x,y,dest_x,dest_y)

		# main_batch.add(2, gl.GL_QUADS, None,
		# 					('v2f', (x, y, dest_x, dest_y)),
		# 					('c3B', (255, 0, 0, 0, 255, 0))
		# 					 #c3B is a gradient (0,0,0, 255,255,255) combo
		...
		v2.draw(gl.GL_QUADS)
		for i in range(20):
			x = randint(0,int(PLAYFIELD/20))
			y = randint(0,int(PLAYFIELD/20))
			pyglet.graphics.draw(1, pyglet.gl.GL_LINES,
					('v2i', (x, y)),
					('c3B', (255, 255, 255))
			)
		#vl.draw(gl.GL_LINES)
		#batch.draw(4,gl.GL_LINES)
		#vl.delete()
		v2.delete()
